...
public class Image {
    ...
    public static String addDish(/*@RequestParam("photos")*/ MultipartFile file /*HttpServletRequest request*/) throws Exception {
        String path = null;// 文件路径
        String sava_path = null;
